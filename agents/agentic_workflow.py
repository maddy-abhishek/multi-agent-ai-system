...
class GraphBuilder():
     ...
     def agent1_function(self,state: MessagesState):
        """Agent 1 function"""
     ...
     def coder_function(self,state: MessagesState):
     ...
     def researcher_function(self,state: MessagesState):
        ...
        response = researcher_llm.invoke(input_question)
        return {"messages": [response],
                "next_agent": "writer"}
     
     def writer_function(self,state: MessagesState):
     ...
     def supervisor_agent(self,state: MessagesState):
        ...
        res = self.llm.invoke([prompt] + task)
     ...
     def agent2_function(self,state: MessagesState):
